...
$sorturl  ="/cgi/genc/cp?mode=ls_topsites&year=$year&month=$month&day=$day";
$sorturl .="&mmode=$mmode" if ($mmode ne "day");
$sorturl .="&order";
...
$whourl = "/cgi/genc/cp?mode=ls_whousesite&year=$year&month=$month&day=$day";
$whourl .="&mmode=$mmode" if ($mmode ne "day");
$whourl .="&usersite";
