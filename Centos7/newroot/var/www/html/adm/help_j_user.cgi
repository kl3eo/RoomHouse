...
my $text = koitoutf8("Логи прокси");
my $texta = koitoutf8("<p>Вы можете просматривать логи пользовательских обращений из вашей локальной сети в Интернет. 
Система меню Lightsquid позволяет делать разнообразные выборки из логов и на этом основании делать выводы о необходимости вносить ресурс в Blacklist.</p>
...
<p>2. Чтобы исключить ранее внесённый сайт, домен или IP из Blacklist, кликните по нему.</p>Внесенные вами изменения начнут действовать незамедлительно.");
