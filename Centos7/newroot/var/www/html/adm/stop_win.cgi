...
if ($wstate eq "running") {
	...
	my $texta_stage3 = koitoutf8("Виртуальная машина работает! Вы хотите внештатно завершить работу?");
	my $textb_stage3 = koitoutf8("Ваши данные будут потеряны, если они не были записаны на диск!");
	...
	my $texta_stage3 = koitoutf8("Windows еще не был запущен. Запустите ваш лицензионный Windows.");
...
#print STDERR "Here check is $check!\n";
	...
	my $texta_stage3 = koitoutf8("Windows был убит без сохранения временных и буферных данных.");
	my $textb_stage3 = koitoutf8("Запустите Windows снова.<div style=\"font-size:48px;cursor:pointer;color:#9cf;\" onclick=\"location.href='/?mode=uc_panel&part=2';\">&#8734;</div>");
